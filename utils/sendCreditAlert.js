...
const sendCreditEmail = async(amount,bankName, email,accountName, accountNumber, dateTime, transactionReference)=>{
    ...
    <tr>
      <td style="padding:30px;">
        <p style="font-size:16px; line-height:1.6; margin:0 0 16px;">
          A credit transaction has been recorded on your QuickPay account.
        </p>
